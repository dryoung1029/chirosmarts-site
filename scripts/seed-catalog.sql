...
VALUES
  ('crs_vitals', 'vitals-monitoring', 'Taking & Recording Vital Signs',
   ...
   1, 5, 'vitals', 'oregon', 'ca', 'ce_course', 'one_time_purchase', 3900, 'draft', 0.8, 1.5, 'Jason Young, DC'),
  ...
  ('crs_hipaa', 'hipaa-essentials', 'HIPAA Essentials for Chiropractic Assistants',
   ...
   1, NULL, 'hipaa', 'oregon', 'ca', 'ce_course', 'one_time_purchase', 3500, 'draft', 0.8, 1.5, 'Jason Young, DC'),

  ('crs_cultural', 'cultural-competency', 'Cultural Competency',
   'Standalone cultural competency CE for chiropractic assistants.',
   1, NULL, 'cultural_competency', 'oregon', 'ca', 'ce_course', 'one_time_purchase', 2900, 'draft', 0.8, 1.5, 'Jason Young, DC'),
  ...
  ('crs_cbt', 'cbt-chiropractic-practice', 'CBT in Chiropractic Practice',
   ...
   1, NULL, 'general', 'oregon', 'ca', 'ce_course', 'one_time_purchase', 4900, 'draft', 0.8, 1.5, 'Jason Young, DC'),
  ...
  ('crs_renewal_bundle', 'annual-renewal-bundle', 'Annual Renewal Bundle (6 hr)',
   ...
   6, NULL, 'general', 'oregon', 'ca', 'ce_course', 'one_time_purchase', 8900, 'draft', 0.8, 1.5, 'Jason Young, DC');
